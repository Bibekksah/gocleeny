            ...
            <section className="relative w-full h-[40vh] flex items-center justify-center">
                ...
                <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-xl text-white/90 max-w-[800px] mt-4">
                        Build a rewarding career with Go Cleeny's eco-friendly cleaning service
                    </p>
                </div>
            </section>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight">Why Join Go Cleeny?</h2>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600">Fill out the form below to apply for a position at Go Cleeny</p>
            </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-center">
                    Thank you for your interest in joining the Go Cleeny team.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  ...
                  <p>We appreciate your interest in Go Cleeny and wish you the best in your job search.</p>
                </CardContent>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="grid gap-2">
                        <Label htmlFor="message">Why do you want to join Go Cleeny?</Label>
                        <Textarea
                          id="message"
                          name="message"
