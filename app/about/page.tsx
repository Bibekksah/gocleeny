    ...
    <main className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <section className="relative w-full h-[50vh] sm:h-[60vh] flex items-center justify-center">
        ...
        <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
          ...
          <h1 className="heading-hero font-heading font-bold text-white tracking-tight mb-4 sm:mb-6">The Go Cleeny Story</h1>
      ...
      <section className="section-padding bg-white">
        <div className="container px-4 md:px-6">
          <div className="grid gap-16 md:grid-cols-2 items-center">
            <div className="relative h-[400px] sm:h-[500px] md:h-[600px] rounded-2xl overflow-hidden shadow-2xl md:order-last transform rotate-1 hover:rotate-0 transition-all duration-700">
            ...
            <div className="space-y-8">
              ...
              <h2 className="heading-section font-heading font-bold tracking-tight text-gray-900 leading-tight">
                Founded on <br className="hidden sm:block" /> Principles of Purity
              </h2>
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed text-justify">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 pt-6 border-t border-gray-100">
                  <div>
                    <div className="text-2xl sm:text-3xl font-bold text-primary font-heading">98%</div>
                    <div className="text-xs sm:text-sm text-gray-500 font-medium">Customer Satisfaction</div>
                  </div>
                  <div>
                    <div className="text-2xl sm:text-3xl font-bold text-primary font-heading">100%</div>
                    <div className="text-xs sm:text-sm text-gray-500 font-medium">Eco-Certified Products</div>
                  </div>
                  <div>
                    <div className="text-2xl sm:text-3xl font-bold text-primary font-heading">500+</div>
                    <div className="text-xs sm:text-sm text-gray-500 font-medium">Happy Homes</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding bg-gray-50 relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="heading-section font-heading font-bold tracking-tight text-gray-900 mb-6 font-heading">The Pillars of Our Service</h2>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={i} className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-premium-hover transition-all duration-300 border border-gray-100 group">
      ...
      <section className="section-padding bg-white">
        <div className="container px-4 md:px-6">
          <div className="bg-primary/5 p-8 sm:p-12 lg:p-16 rounded-3xl overflow-hidden relative">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl -mr-16 -mt-16" />

            <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
              <div className="flex-1 space-y-6 text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl font-heading font-bold tracking-tight text-gray-900">Proudly Part of the SAMBIC Group</h2>
