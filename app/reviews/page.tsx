            ...
            <section className="section-padding bg-white relative overflow-hidden">
                <div className="container px-4 md:px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                        {stats.map((stat, idx) => (
                            <div key={idx} className="text-center p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <section className="py-6 bg-white border-b border-gray-100">
                <div className="container px-4 md:px-6 text-center">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
                        ...
                        <div className="relative">
                            ...
                            >
                                {allReviews.map((review: Review) => (
                                    <div
                                        key={review.id}
                                        className="bg-gray-50 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 flex flex-col min-w-[280px] w-[280px] md:min-w-[300px] md:w-[300px] snap-start shrink-0"
                                    >
